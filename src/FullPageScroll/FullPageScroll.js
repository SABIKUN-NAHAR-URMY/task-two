...
import img21 from '../images/mobile-app-of-the-year-by-entrepreneur.png';
import img22 from '../images/nasa-mobile-app.png';
                ...
                <FullpageSection className='sectionStyle'>
                    <div className='divStyle'>
                        <div className='bg-purple-600 p-5 lg:p-28 relative' >
                            ...
                            <h1 className='text-white invisible lg:visible text-4xl font-bold absolute right-32 top-52'>25M+ Downloads <br /><span className='text-lg'>On appstore and google playstore</span></h1>
                            <div>
                                <svg className=' invisible lg:visible absolute bg-purple-600 top-40 w-52 -right-20 rounded-full'
                ...
                <FullpageSection className='sectionStyle'>
                    <div className='divStyle'>
                        <div className='bg-blue-700 p-5 lg:p-40 relative' >
                            ...
                            <h1 className='text-white absolute invisible lg:visible text-lg right-32 top-52'>The next big <br /><span className='text-4xl font-bold '>BlockChain</span> <br /> Revolution</h1>
                            <svg className='absolute invisible lg:visible bg-blue-700 top-40 w-52 -right-20 rounded-full'
                                xmlns="http://www.w3.org/2000/svg"
                                x="0"
                                y="0"
                                enableBackground="new 0 0 414 414"
                ...
                <FullpageSection className='sectionStyle'>
                    <div className='divStyle'>
                        <div className='bg-indigo-900 p-24 lg:p-40 relative' >
                            ...
                            <h1 className='text-white absolute invisible lg:visible text-lg right-32 top-52'>Powered by advanced<br /><span className='text-4xl font-bold '><img src={img22} className='w-48' alt="" /></span> <br /> algorithms</h1>
                            <svg className='absolute invisible lg:visible bg-indigo-900 top-40 w-52 -right-20 rounded-full'
                                xmlns="http://www.w3.org/2000/svg"
                                x="0"
                                y="0"
                                enableBackground="new 0 0 414 414"
                ...
                <FullpageSection className='sectionStyle'>
                    <div className='divStyle'>
                        <div className='bg-cyan-900 p-11 lg:p-32 relative' >
                            ...
                            <h1 className='text-white absolute invisible lg:visible text-lg right-32 top-52'>Redefining<br /><span className='text-4xl font-bold '>UX Strategy</span> <br /> and UX design</h1>
                            <svg className='absolute invisible lg:visible bg-cyan-900 top-40 w-52 -right-20 rounded-full'
                                xmlns="http://www.w3.org/2000/svg"
                                x="0"
                                y="0"
                                enableBackground="new 0 0 414 414"
                ...
                <FullpageSection className='sectionStyle'>
                    <div className='divStyle'>
                        <div className='bg-sky-700 p-11 lg:p-32 relative' >
                            ...
                            <h1 className='text-white absolute invisible lg:visible text-lg right-32 top-52'>Text Headline<br /><span className='text-4xl font-bold '>Text Headline</span> <br /> Footer Headline</h1>
                            <svg className='absolute invisible lg:visible bg-sky-700 top-40 w-52 -right-20 rounded-full'
                                xmlns="http://www.w3.org/2000/svg"
                                x="0"
                                y="0"
                                enableBackground="new 0 0 414 414"
                ...
                <FullpageSection className='sectionStyle'>
                    <div className='divStyle'>
                        <div className='bg-purple-600 p-6 lg:p-28 relative' >
                            ...
                            <h1 className='text-white absolute invisible lg:visible text-lg right-32 top-52'>Developing ERP solution for <br /><span className='text-4xl font-bold '>Text Headline</span> <br /> in future industry</h1>
                            <svg className='absolute invisible lg:visible bg-purple-600 top-40 w-52 -right-20 rounded-full'
                                xmlns="http://www.w3.org/2000/svg"
                                x="0"
                                y="0"
                                enableBackground="new 0 0 414 414"
                ...
                <FullpageSection className='sectionStyle'>
                    <div className='divStyle'>
                        <div className='bg-emerald-800 p-11 lg:p-32 relative' >
                            ...
                            <h1 className='text-white absolute invisible lg:visible text-lg right-32 top-52'>Biggest classifieds <br /><span className='text-4xl font-bold '>East Asia</span> <br /> Countries</h1>
                            <svg className='absolute invisible lg:visible bg-emerald-800 top-40 w-52 -right-20 rounded-full'
                                xmlns="http://www.w3.org/2000/svg"
                                x="0"
                                y="0"
                                enableBackground="new 0 0 414 414"
